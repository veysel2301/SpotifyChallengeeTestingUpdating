  ...
  * def requestbodyHappy =
  ...
  Scenario: End to End Scenario Faz-2
    ...
    * def trackUri = response.tracks.items[0].uri
    ...
    When method post
    #Yeah! (feat. Lil Jon & Ludacris) parçası oynatılır
    ...
    * delay(2000)
    #Ruh hali kategorisine tıklanır ve Mutlu Türkçe Şarkılar plaaylistine tıklanır
    ...
    * delay(10000)
    ...
    #Give Me Everythhink adlı parça eklenir
